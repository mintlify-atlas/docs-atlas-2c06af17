---
title: "Configuration Endpoint: Dynamic Threshold Updates"
sidebarTitle: "Config"
description: "The PUT /api/config/threshold endpoint lets you update the stock alert threshold at runtime without restarting the server."
---
