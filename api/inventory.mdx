---
title: "Inventory Endpoints: Real-Time Stock State and Lookup"
sidebarTitle: "Inventory"
description: "HTTP routes for querying real-time inventory state, looking up individual products by SKU, and resetting all stock levels to initial values."
---
