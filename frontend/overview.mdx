---
title: "Anaquel Inteligente 3B Dashboard: React Frontend Overview"
sidebarTitle: "Overview"
description: "React + Vite dashboard for Anaquel Inteligente 3B: live shelf inventory, video feeds, predictions, heatmaps, and event logs via Socket.IO."
---
