---
title: "Camera Capture: RTSP and USB Camera Frame Acquisition"
...
<ResponseField name="frame_id" type="int">
  Monotonically increasing frame counter, initialised to `0` when the
  `CameraCapture` object is constructed. It is not reset on reconnection.
</ResponseField>
