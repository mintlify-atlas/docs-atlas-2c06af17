...
description: "InventoryEngine is the core M3 module that maintains stock counters for 7 SKUs, applies business logic, fires alert callbacks, and exposes analytics and restock recommendations."
---
